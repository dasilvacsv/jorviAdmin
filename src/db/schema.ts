...
// ----------------------------------------------------------------
// TABLA PARA CONFIGURACIÓN DE TASAS DE CAMBIO POR RIFA
// ----------------------------------------------------------------
...
export const systemSettings = pgTable("system_settings", {
  id: text("id").primaryKey().$defaultFn(() => createId()),
  key: text("key").notNull().unique(), // 'commission_rate', 'default_exchange_rate', etc.
...
export const raffleExchangeRatesRelations = relations(raffleExchangeRates, ({ one }) => ({
  raffle: one(raffles, {
